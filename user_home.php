...
//                               
                    ...
                    <div class="header-menu-block">
                        ...
                        <ul class="header-menu" id="one">
                            ...
                            <div class="login-header-block">
                                <div class="login_block">
                                    <li><a class="messages-popup" href="#">
                    ...
                    <center><div class=" col-md-7">
                            <div id="container-mix"  class="row _post-container_">
                                <div class="tab-wrapper style-1">
                                    ...
                                    <?php
                                      $res =mysql_query("select * from  add_profile join posts on add_profile.reg_id=posts.user_id where user_id=$id or user_id in(select user_id from friend_request where frnd_id='$id') or user_id in(select user_id from friend_request where frnd_id='$id')  and status='Friends' order by pid desc");
                                            ...
                                            <br/><br/> <div class="col-lg-7">
                                                <div class="be-post">
                                                    ...
                                                    <span class="glyphicon glyphicon-user">&nbsp;<?php echo $row1["protect"] ?></span>
                                                        ...
                                                        ?>
                                                    <span class="glyphicon glyphicon-user">&nbsp;<?php echo $row1["protect"] ?></span>
                                                        <a href="comments.php?pid=<?php echo $row1["pid"] ?>" class="be-img-block" id="img">
